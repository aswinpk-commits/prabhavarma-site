...
<section class="sec">
  ...
  <div class="gallery">
    ...
    <figure class="big"><img src="images/cheruthazham-temple.jpg" alt="At the Cheruthazham temple" loading="lazy"><figcaption>{b("Cheruthazham temple — where his first poem was written", "ചെറുതാഴം ഇല്ലത്തെ ക്ഷേത്രം — ആദ്യ കവിത രചിച്ച സ്ഥലം")}</figcaption></figure>
    ...
    <figure class="big"><img src="images/vayalar-shyamamadhavam.jpg" alt="At the Vayalar Award function" loading="lazy"><figcaption>{b("At the Vayalar Award function for <em>Shyama Madhavam</em>", "<em>ശ്യാമമാധവ</em>ത്തിനുള്ള വയലാർ അവാർഡ് ചടങ്ങിൽ")}</figcaption></figure>
    ...
    <figure class="tall"><img src="images/sahitya-akademi-speaking.jpg" alt="Speaking at the Sahitya Akademi" loading="lazy"><figcaption>{b("At the Sahitya Akademi, New Delhi", "സാഹിത്യ അക്കാദമിയിൽ, ന്യൂഡൽഹി")}</figcaption></figure>
    <figure class="big"><img src="images/with-jerry-amaldev.jpg" alt="With composer Jerry Amaldev" loading="lazy"><figcaption>{b("With the composer Jerry Amaldev", "സംഗീതസംവിധായകൻ ജെറി അമൽദേവിനൊപ്പം")}</figcaption></figure>
    <figure class="big"><img src="images/with-sarada.jpg" alt="With actress Sarada" loading="lazy"><figcaption>{b("With the actress Sarada", "നടി ശാരദയോടൊപ്പം")}</figcaption></figure>
    ...
    <figure class="big"><img src="images/with-mt-vasudevan-nair.jpg" alt="With M. T. Vasudevan Nair" loading="lazy"><figcaption>{b("With M. T. Vasudevan Nair", "എം. ടി. വാസുദേവൻ നായർക്കൊപ്പം")}</figcaption></figure>
    ...
    <figure class="big"><img src="images/caricatures.jpg" alt="Caricatures of Prabha Varma by various artists" loading="lazy"><figcaption>{b("As cartoonists have seen him", "കാർട്ടൂണിസ്റ്റുകളുടെ കണ്ണിൽ")}</figcaption></figure>
    <figure class="big"><img src="images/portrait-seated.jpg" alt="Prabha Varma" loading="lazy"><figcaption>{b("Thiruvananthapuram, 2024", "തിരുവനന്തപുരം, 2024")}</figcaption></figure>
